        ...
        <div class="col-md">
            <div class="card">
                <div class="card-header">
                    <h5>Редактировать профессию</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label for="professionName" class="form-label">Название профессии</label>
                        <input autocomplete="off" type="text" class="form-control" id="name" value="{{$profession->name}}"
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary">Обновить профессию</button>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{url('assets/js/apps/professions/edit.js')}}"></script>
</body>
</html>
