...
<div>
    @include('departments.components.deleteModal')
        ...
        <table class="table">
            ...
            @if(!$departments->isEmpty())
                @foreach($departments as $department)
                    @include('departments.components.department', ['department'=> $department])
                @endforeach
            @endif
            </tbody>
        </table>
...
<script src="{{url('assets/js/apps/departments/index.js')}}"></script>
