...
<div>
    @include('items.components.deleteModal')
            ...
            <div class="filters__block">
                <form autocomplete="off" method="GET">
                    <div class="filters__content">
                        @include('items.components.filters',['categories' => $categories])
...
<script src="{{url('assets/js/apps/items/index.js')}}"></script>
