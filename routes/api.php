...
Route::group(['prefix' => 'users', 'middleware' => ['user-api', 'role-api:admin']], function () {
    Route::post('/', [UsersController::class, 'store']);
    Route::put('/{user}', [UsersController::class, 'update']);
    Route::delete("/{user}", [UsersController::class, 'destroy']);
});

Route::group(['prefix' => 'items', 'middleware' => ['user-api']], function () {
...
Route::group(['prefix' => 'professions', 'middleware' => ['user-api']], function () {
...
Route::group(['prefix' => 'employees', 'middleware' => ['user-api']], function () {
...
Route::group(['prefix' => 'departments', 'middleware' => ['user-api']], function () {
...
Route::group(['prefix' => "used", 'middleware' => ['user-api']], function () {
